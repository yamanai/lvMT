    ...
    <transition name="fade">
      ...
      <div id="calendar" v-show="changeShowCalendar">
        <div id="calendar-header">
          <span class="arrow" :class="{disabled:selectMonth==limit.minMonth}" @click="subMonth">&lt;</span>
          <span class="arrow" :class="{disabled:selectYear==limit.minYear}" style="fontSize:80%" @click="subYear">&lt;</span>
          <span id="date-box">
            {{trueSelectMonths}} {{trueSelectYear}}
          </span>
          <span class="arrow" :class="{disabled:selectYear==limit.maxYear}" style="fontSize:80%" @click="addYear">&gt;</span>
          <span class="arrow" :class="{disabled:selectMonth==limit.maxMonth}" @click="addMonth">&gt;</span>
        </div>
        <div class="week">
