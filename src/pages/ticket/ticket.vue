	...
	<div class="wrapper flex">
		<div class="ticket">
			<div class="ticket-head flex">
				<div class="logo"></div>
				<div class="timer">
					<span>{{orders[0].voyageinfo[0].fn.an}}</span>
					<span>{{orders[0].voyageinfo[0].fn.slice(0,2)}} {{orders[0].voyageinfo[0].fn.slice(2)}}</span>
				</div>
			</div>
			<div class="ticket-cont">
				...
				<div class="passenger">
					<div class="passenger-list">
						...
						<div class="cont" v-for="item in orders[0].travellerinfo">
