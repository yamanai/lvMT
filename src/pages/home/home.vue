        ...
        <div class="content">
            ...
            <div class="travel">
                <div class="travel-group flex space-between clear">
                    ...
                    <div class="travel-search" tabindex="0">
                        <input v-model="departAirportString" @focus="fromFocus" id="travel-from" ref="travelFrom"
                               @keyup="watchFrom"
                               type="text" placeholder="Depart"/>
                        <a v-show="departAirportString!=''" @click="departAirportString=''" id="from-close"
                           href="javascript:"></a>
                ...
                <div class="travel-group flex clear">
                    <span>To</span>
                    <div class="travel-search" tabindex="0">
                        <input v-model="destinationAirportString" @focus="toFocus" id="travel-to" ref="travelTo"
                               @keyup="watchTo"
                               type="text" placeholder="Destination"/>
                        <a v-show="destinationAirportString!=''" @click="destinationAirportString=''" id="to-close"
                           href="javascript:"></a>
            ...
            <div class="choose-class flex space-between">
                ...
                <div class="selec-group" @click="showClass" tabindex="0" @blur="hideClass">
                    ...
                    <ul class="hide">
                        <li v-for="clazz in cabinClasses" @click="setCabinClass(clazz)">
                            {{CabinClassUtil.getClassString(clazz)}}
                        </li>
                    </ul>
                </div>
            </div>
