<template>
	<div class="wrapper">
		<head-top class="header">
			...
			<a slot="right" v-show="true" @click="skipFilter" ><img :src="heads.img2" alt=""></a>
		</head-top>
			...
			<div class="total">
				<div class="total-cont flex space-between align-items-center">
					...
					<div class="total-price">
						...
						<div class="total-price-ecash">
							<span class="rs">RS.</span>
							<span>1000 eCash</span>
						</div>
					</div>
							...
							<div class="flight-detail-info left">
								...
								<div class="flight-price clear">
									<div class="present-price left">
										<span class="rs">Rs.</span>
										<span v-if="selectedDepartFlightIndex==index">{{item.realPrice | formatDate}}</span>
		...
		methods:{
			...
			sorts(sortType,itemObj,obj,flightType){
				...
				if(flightType=="depart"){
					 flightHtmlObjArr= $(".flight-detail-track-return")
					 f=true
